...
import { archiveEpisode, getArchivePodcastsById, getArchivedEpisodes, getEpisodesArchive, getPodcastEpisodes, getPodcastsById } from "@/app/api/publishers";
...
const EpisodeItemTable: React.FC<{ episodes: EpisodeModel[] }> = ({ episodes }) => {
            ...
            <div className="mt-8">
                {
                    viewMode == "list" ? <div className={`${viewMode == "list" ? "divide-y pr-12" : "grid grid-cols-4 gap-y-8"}`}>
                        ...
                        <EpisodeItemTable episodes={episodes} />
                }
            </div>
        </div >
    )
